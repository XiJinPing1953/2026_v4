...
- [09-10普通导出修复](handoffs/2026-09-10-statement-export-fix.md)记录当前结算函数/H5补丁及实际下载验收；[逐户核账](handoffs/2026-09-10-customer-accounting-audit.md)分别记录逐单证据、用户确认与核准范围，不因程序修复自动核准客户。
