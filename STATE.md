...
- 客户对账工作区试做已实现于 `codex/statement-workspace-preview`，基线 `1ed1ec5`，用户已批准正式上线；反馈修正已完成，待正式构建与托管验证，尚未部署。分区查看、收款左右对照、独立分页和预览失效保护；验收与回退见[试做交接](state/handoffs/2026-09-20-statement-workspace-preview.md)。本工作区未带入 main 的未提交文档，以下历史运行版本不代表 09-20 最新生产。
