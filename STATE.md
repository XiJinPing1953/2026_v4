...
更新时间：2026-09-20（试做工作区）。工程契约见[RULES](docs/RULES.md)，按需选择[领域](state/INDEX.md)。本页只维护当前任务、生产版本和继续条件。
...
- 客户对账工作区试做已实现于 `codex/statement-workspace-preview`，基线 `1ed1ec5`，已按用户授权发布H5 `1789836236314-37224524`，源码 `c18928a`；180资源回读通过，原网页包可回退。生产登录后页面待用户现场体验。分区查看、收款左右对照、独立分页和预览失效保护；验收与回退见[试做交接](state/handoffs/2026-09-20-statement-workspace-preview.md)。本工作区未带入 main 的未提交文档，以下历史运行版本不代表 09-20 最新生产。
