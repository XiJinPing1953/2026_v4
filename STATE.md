...
- 客户对账与主要页面性能优化已上线：对账本地读取111→45次，线上20次P50 8.33→5.05秒、P95 8.86→5.50秒；列表/统计分离、出纳首次去重、首页15/60秒分频及7表8个非唯一索引完成；损耗查询60秒超时修复至2.1秒。云函数`82703b2`/损耗`4605833`、H5`1789828796517-22c4e159`；会计现场耗时及生产保存耗时未测量，见[性能优化交接](state/handoffs/2026-09-19-query-performance.md)。
