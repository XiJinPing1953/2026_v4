...
- 出纳气款/押金/混合到账联动已在 `codex/cashier-intake-linked-funds` 完成本地实现，基线 `1503228`；225项去重自动化测试及H5构建通过，对账样例保持45次读取。尚未发布或写真实账务，新登记关闭；浏览器预览监听权限及CRM重新登录后的线上验收待完成。见[到账联动交接](state/handoffs/2026-09-20-cashier-linked-funds.md)。
