...
var jpPrinter = {
  createNew: function () {
	...
	jpPrinter.setBold = function (bold) {
      data = "SETBOLD " + bold + "\r\n";
      jpPrinter.addCommand(data)
    };
    ...
    jpPrinter.setBitmap = function (x, y, mode, res) {  //添加图片，res为画布参数
      // console.log(res)
	  console.log("jpPrinter.setBitmap()")
      var width = parseInt((res.width + 7) / 8 * 8 / 8)
	  console.log("jpPrinter.setBitmap() --0")
      ...
      data = "BITMAP " + x + "," + y + "," + width + "," + height + "," + mode + ","
	   console.log("jpPrinter.setBitmap() --1")
      jpPrinter.addCommand(data)
      for (var i = 0; i < height; ++i) {
	   ...
	   console.log("jpPrinter.setBitmap() --4")
